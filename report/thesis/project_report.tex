...
\begin{figure}[htbp]
    ...
    \caption{Example of car, bicycle, and pedestrians.}
...
Route generation is controlled by several parameters, and the ones we use are:
