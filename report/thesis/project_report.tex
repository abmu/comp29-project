...
In Figure~\ref{fig:netedit_demo}, the red circles and intermediary maroon links indicate junctions, whereas the in between sections are the edges. Each edge can be comprised of a bike lane, pedestrian lane, and/or vehicle lane as shown. Additionally, crossings have been added to the junctions, and a configurable traffic light system has been added with the lane connections appropriately adjusted.
...
Tools made available... Create a script...

Include image of pedestrians, bicycle, and cars...
