...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/sumo_network.png}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{images/sumo_traffic_light.png}
        \caption{Traffic light phase configuration.}
        \label{fig:sumo_traffic_light}
    \end{subfigure}
    \caption{SUMO simulation environment.}
    \label{fig:sumo_environment}
\end{figure}
